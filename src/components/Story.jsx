    ...
    text-blue-50">
        ...
        pb-24">
            ...
            <div className="relative size-full">
                <AnimatedTitle
                 title="hac<b>hin</b>osu <br /> the <b>pirate</b> island"
                sectionId="#story"
            ...
            md:me-44 md:justify-end">
                ...
                md:items-start">
                    ...
                    font-circular-web text-violet-50 md:text-start">
                        Where outlaws converge, lies Hachinosu and its fractured skull. Forge your legacy in the ashes of empires and claim your bounty amidst the chaos of the New Era!
                    </p>
